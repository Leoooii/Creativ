      ...
      <div className="container mx-auto px-8">
        <div className="flex flex-wrap justify-between">
          <div className="w-full md:w-1/4 mb-2">
            <h2 className="text-lg font-bold mb-2">POLITICA SI TERMENI LEGALI</h2>
            <ul>
              <li>
          ...
          <div className="w-full md:w-1/4 mb-2">
            ...
            <ul>
              ...
              <li className="flex">
                ...
                <h3 className="text-gray-400 hover:text-white">contact@creativtub.ro</h3>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 mt-6 pt-4 text-center">
          <p className="text-gray-400">
            &copy; {new Date().getFullYear()} CREATIV TUB SRL. Toate drepturile rezervate.
          </p>
          {/* <p className="text-gray-500">Website realizat de Ilie Leonard-Andrei</p> */}
        </div>
      </div>
    </footer>
  );
